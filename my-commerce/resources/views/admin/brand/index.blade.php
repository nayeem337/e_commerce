        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('brands.store') }}" method="post" class="form-horizontal p-t-20" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control" id="editor" placeholder="Brand Description"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
