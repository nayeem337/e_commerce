        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('sub-categories.update', $subCategory->id) }}" method="post" class="form-horizontal p-t-20" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ $subCategory->name }}" name="name" id="exampleInputuname3" placeholder="Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputEmail3" class="col-sm-3 control-label">Sub Category Description <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control" id="editor" placeholder="Category Description">{{ $subCategory->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <label class="me-3"><input type="radio" name="status" {{ $subCategory->status == 1 ? 'checked' : '' }} value="1"> Published</label>
