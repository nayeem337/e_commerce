                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            ...
                            <div class="xzoom-thumbs">
                                ...
                                <a href="{{ asset($otherImage->image) }}"><img class="xzoom-gallery" width="80" src="{{ asset($otherImage->image) }}"  xpreview="{{ asset($otherImage->image) }}" title="{{$product->short_description }}"></a>
                                @endforeach
                            </div>
                        </div>
                    </div>
